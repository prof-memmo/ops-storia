        ...
        if (cell.isEnd) {
          return (
            <div key={cell.index} className="relative w-36 h-36 sm:w-56 sm:h-56 flex items-center justify-center bg-slate-50 rounded-3xl border-8 border-yellow-400 shadow-2xl p-4 shrink-0 mx-4">
              <img src="https://prof-memmo.github.io/prof-memmo-gestione-siti/shared/assets/branding/games/ops-storia-badge.png" alt="Traguardo" className="w-full h-full object-contain" />
